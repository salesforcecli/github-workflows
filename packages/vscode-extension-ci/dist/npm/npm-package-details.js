 ...
 */
export function extractPackageDetails(selectedPackagesJson, versionBump) {
                ...
                for (const packageName of packages) {
                    if (packageName && typeof packageName === 'string') {
                        ...
                        if (details) {
                            ...
                            log.debug(`Package ${packageName}: ${details.name}@${details.version}`);
                        }
                    }
                }
            }
 ...
 */
export function setPackageDetailsOutputs(details) {
...
//# sourceMappingURL=npm-package-details.js.map