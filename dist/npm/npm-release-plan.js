...
import { log, parseVersion, formatVersion } from '../core/utils.js';
/**
...
function calculateNewVersion(currentVersion, versionBump) {
    try {
        ...
        switch (versionBump) {
            ...
            default:
                log.warning(`Unknown version bump type: ${versionBump}, defaulting to patch`);
                return formatVersion(major, minor, patch + 1);
        }
    }
    catch (error) {
 ...
 */
export function generateReleasePlan(packageName, versionBump, dryRun = false) {
 ...
 */
export function displayReleasePlan(plan) {
...
//# sourceMappingURL=npm-release-plan.js.map