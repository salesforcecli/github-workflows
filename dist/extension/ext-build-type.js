 ...
 */
import { setOutput, log, booleanString, versionBumpType } from '../core/utils.js';
/**
 * Determine the build context based on GitHub event and inputs
 */
export function determineBuildType() {
    ...
    if (isNightly) {
        ...
        try {
            ...
            log.warning(`Invalid version bump type: ${inputBump}, defaulting to 'auto'`);
            versionBump = 'auto';
        }
    }
    ...
    if (isNightly) {
        ...
        try {
            ...
            log.warning(`Invalid pre-release value: ${inputPreRelease}, defaulting to false`);
            preRelease = false;
        }
    }
 ...
 */
export function setBuildTypeOutputs(buildContext) {
...
//# sourceMappingURL=ext-build-type.js.map