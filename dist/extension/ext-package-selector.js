...
export function getAvailableExtensions() {
    ...
    log.info(`Found ${extensions.length} VS Code extensions: ${extensions.join(', ')}`);
 ...
 */
export function setExtensionDiscoveryOutputs(extensions) {
...
//# sourceMappingURL=ext-package-selector.js.map