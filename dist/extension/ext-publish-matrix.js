        ...
        if (existsSync(packageJsonPath)) {
            try {
                ...
                if (packageJson.publisher) {
                    ...
                    log.debug(`Found VS Code extension: ${packageName} (publisher: ${packageJson.publisher})`);
                }
                else {
...
function getVsixPattern(extension) {
    switch (extension) {
...
function getMarketplaceName(registry) {
    switch (registry) {
        case 'vsce':
...
function determinePublishMatrix(options) {
...
//# sourceMappingURL=ext-publish-matrix.js.map